...
export default function Contact() {
  return (
    <section id="contact" className="relative min-h-screen w-full overflow-hidden bg-slate-50 dark:bg-slate-900">
      {/* Background elements */}
      ...
      <div className="container relative mx-auto px-4 py-20 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative space-y-8 px-4 sm:px-0"
          >
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    id="email"
                    name="email"
                    placeholder="erick@lematrixai.com"
                    required
                    className="mt-1 block w-full rounded-md border border-slate-300 bg-white/95 px-4 py-2 text-slate-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800/95 dark:text-slate-100"
                  />
                </div>
